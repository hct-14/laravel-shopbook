...
<html lang="en">
   ...
   <body>
                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li>
                        ...
                        <ul id="ui-elements" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="elements">
                               <a href="{{ URL::to("/danh-muc-san-pham/".$cate_pro->category_id) }}" class="iq-waves-effect">
                     ...
                     <li><a href="{{URL::to('/index-dien-dan')}}"><i class="ri-book-line"></i>Diễn đàn</a></li>
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="iq-search-bar">
                     <form action="{{URL::to('/search')}}" method="post" class="searchbox">
                        @csrf
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav ml-auto navbar-list">
                        ...
                        <li class="nav-item nav-icon dropdown">
                           <a href="{{asset("/show-cart1")}}" class="search-toggle iq-waves-effect text-gray rounded">
                           <i class="ri-shopping-cart-2-line" aria-hidden="true"></i>  
                           <span class="badge badge-danger count-cart rounded-circle">{{ count((array) session('cart')) }}</span>
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 toggle-cart-info">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="rounded" src="{{asset("../FE2/images/cart/01.jpg")}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                        ...
                        <li class="line-height pt-3">
                           <div class="user-menu">
                               <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                                 <img src="{{ asset('/uploads/avt/' . session('avt')) }}" class="img-fluid rounded-circle mr-3" alt="user" width="50px" height="50px">
                                 <div class="caption">
                                   ...
                                   <div class="dropdown-content">
                                       ...
                                       <a href="{{url("/userlogout")}}">Đăng Xuất</a>
                                   </div>
                               </a>
                           </div>
                       </li>
      ...
      <script src="{{asset("../FE2/js/test.j")}}s"></script>
