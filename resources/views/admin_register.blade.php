                      ...
                      <div class="col-sm-12 sign-in-page-data">
                          <div class="sign-in-from bg-primary rounded">
                              ...
                              <form class="mt-4 form-text">
                                <form action="/user-login-hct" method="POST" class="form" id="form-2">

                                  <div class="form-group">
                                      <label for="exampleInputEmail1">Tài Khoản</label>
                                      <input type="text" class="form-control mb-0" name="user_loginname" id="user_loginname" placeholder="nhap tai khoan">
                                  </div>
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">Password</label>
                                      <a href="#" class="float-right text-dark">Forgot password?</a>
                                      <input type="password" class="form-control mb-0" id="user_password" name="user_password" placeholder="Password">
                                  </div>
