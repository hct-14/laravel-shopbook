                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-2">
                                                <span class="checkout-product-img">
                                                    <a href="javascript:void();"><img class="img-fluid rounded" src="{{asset('/uploads/product/'. $cart_item['image']) }}" alt=""></a>
                                                </span>
                                            </div>
                                            <div class="col-sm-4">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="row align-items-center mt-2">
                                                         <div class="col-sm-7 col-md-6">
                                                            ...
                                                            <input type="number" name="quantity" min="1" value="{{ $cart_item['quantity'] }}" class="quantity-input" style="width: 50px;"> <!-- Thay đổi giá trị của width ở đây -->
                                                            <button type="button" class="fa fa-plus qty-btn" id="btn-plus">+</button>
                                                        </div>
                                                        
                                                            <div class="col-sm-5 col-md-6">
                                                                <div class="col-md-12">
                                                                    <p class="text-success"><strong>Tổng: <span class="item-total">{{ $cart_item['product_price'] * $cart_item['quantity'] }}</span>đ</strong></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <a href="{{ URL::to('/delete-cart/'. $cart_item['id']) }}" class="text-dark font-size-20"><i class="ri-delete-bin-7-fill"></i></a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                </div>
                        ...
                        <div class="iq-card">
                            <div class="iq-card-body">
                                ...
                                <div class="d-flex justify-content-between mb-1">
                                    <span>Tổng</span>
                                    <p class="text-success"><strong>Tổng: {{ $totalProducts }} sản phẩm</strong></p>
                                 </div>
                                <div class="d-flex justify-content-between mb-1">
                                ...
                                @if(session('UserId'))
                                <a id="place-order" href="{{URL::to("/checkout")}}" class="btn btn-primary d-block mt-3 next">Đặt hàng</a>
                                 @else
                                 <a id="place-order" href="{{URL::to("/user-login-hct")}}" class="btn btn-primary d-block mt-3 next">Đặt hàng</a>
                                 @endif
