...
<head>
    ...
    <title>Đăng ký</title>
    <script src="{{ asset("../FE2/js/login-hct.js") }}"></script>
    <link rel="stylesheet" href="{{ asset("../FE2/css/user.login-hct.css") }}">
</head>
<body>
  <form action="{{ url('user-res') }}" method="POST" class="form" id="form-1" enctype="multipart/form-data">
    @csrf 
