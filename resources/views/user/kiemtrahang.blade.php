...
<main>
    ...
    <table class="custom-table">
        ...
        <tr>
            ...
            <td>{{$pro_item->product_title}} </td>
            {{-- <td>{{$pro_item->order_receiver}} </td> --}}
            <td>{{$pro_item->order_value}} </td>

            <td>{{$pro_item->order_phone}} </td>
            <td>{{$pro_item->oder_email}} </td>
            <td>{{$pro_item->order_address}} </td>
            <td>{{$pro_item->order_notes}} </td>
            <td>
                @if ($pro_item->oder_status == 0)
    ...
    <table class="edit-table" style="display: none;">
        ...
        <tr>
            <form action="{{url("/sua-thong-tin")}}" method="POST">
                @csrf
                @foreach ($orders as $pro_item)
                <td><input type="hidden" id="order_id" name="order_id" value="{{$pro_item->order_id}}"></td>

                <td><input type="text" id="fullname" name="fullname" value="{{$pro_item->order_receiver}}"></td>
                <td><input type="text" id="phone" name="phone" value="{{$pro_item->order_phone}}"></td>
                <td><input type="text" id="email" name="email" value="{{$pro_item->oder_email}}"></td>
                <td><input type="text" id="address" name="address" value="{{$pro_item->order_address}}"></td>
                <td><input type="text" id="note" name="note" value="{{$pro_item->order_notes}}"></td>
                {{-- <td><input type="text" id="status" name="status" value="Trạng Thái"></td> --}}
