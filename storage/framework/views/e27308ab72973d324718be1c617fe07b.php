...
<body>
  <form action="<?php echo e(url('user-res')); ?>" method="POST" class="form" id="form-1">
    <?php echo csrf_field(); ?> <!-- Đây là mã CSRF token để đảm bảo tính bảo mật -->
...
</html><?php /**PATH C:\xampp\htdocs\hct-laravel\webshopphake\resources\views/user/register.blade.php ENDPATH**/ ?>