...
<html lang="en">
   ...
   <body>
      ...
      <div class="wrapper">
         ...
         <div class="iq-sidebar">
            <div class="iq-sidebar-logo d-flex justify-content-between">
               <a href="<?php echo e(asset("/trang chu")); ?>" class="header-logo">
            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li><a href="<?php echo e(URL::to('/index-dien-dan')); ?>"><i class="ri-book-line"></i>Diễn đàn</a></li>
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="iq-search-bar">
                     <form action="<?php echo e(URL::to('/search')); ?>" method="post" class="searchbox">
                        <?php echo csrf_field(); ?>
                        <input type="text" name="keyword_submit" class="text search-input" placeholder="Tìm kiếm sản phẩm..." >
                        <input type="submit"  class="btn btn-default btn-sm search-link" name="search_item" value="">
                     </form>
                  </div>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav ml-auto navbar-list">
                        ...
                        <li class="nav-item nav-icon dropdown">
                           <a href="<?php echo e(asset("/show-cart1")); ?>" class="search-toggle iq-waves-effect text-gray rounded">
                        ...
                        <li class="line-height pt-3">
                           <div class="user-menu">
                               <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                                 <img src="<?php echo e(asset('/uploads/avt/' . session('avt'))); ?>" class="img-fluid rounded-circle mr-3" alt="user" width="50px" height="50px">
                                 <div class="caption">
                                    ...
                                    <?php echo e(session('fullName')); ?>"
                                       ...
                                       <p class="user-role">Tài Khoản</p>
                                   </div>
                                   <div class="dropdown-content">
                                       <a href="#">Tài Khoản Của Tôi</a>
                                       <a href="<?php echo e('/kiem-tra-hang/' . session('UserId')); ?>">Đơn Mua</a>
                                       <a href="<?php echo e(url("/userlogout")); ?>">Đăng Xuất</a>
                                   </div>
                               </a>
                           </div>
                       </li>
      ...
      <script src="<?php echo e(asset("../FE2/js/test.j")); ?>s"></script>
...
let sidebarCollapsed = false; // Ban đầu side bar không thu gọn

toggleSidebar.addEventListener('click', function() {
    // Đảo ngược trạng thái thu gọn khi click
    sidebarCollapsed = !sidebarCollapsed;

    // Thêm hoặc xoá lớp CSS để thay đổi kích thước hoặc ẩn side bar
    if (sidebarCollapsed) {
...
</html><?php /**PATH C:\xampp\htdocs\hct-laravel\hoangcongthanh-final\resources\views/layout2.blade.php ENDPATH**/ ?>