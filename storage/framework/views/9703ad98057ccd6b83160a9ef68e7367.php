                  ...
                  <ul id="newrealease-slider" class="list-inline p-0 m-0 d-flex align-items-center">
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("../FE2/images/new_realeases/img01.jpg")); ?>" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("../FE2/images/new_realeases/07.jpg")); ?>" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("../FE2/images/new_realeases/img05.jp")); ?>g" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("../FE2/images/new_realeases/img04.jpg")); ?>" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("..FE2/images/new_realeases/img05.jpg")); ?>" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("../FE2/images/new_realeases/01.jpg")); ?>" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                     <li class="item">
                        <a href="javascript:void(0);">
                     ...
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("..FE2/images/new_realeases/08.jpg")); ?>" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                     <li class="item">
                        <a href="javascript:void(0);">
                           <img src="<?php echo e(asset("../FE2/images/new_realeases/09.jpg")); ?>" class="img-fluid w-100 rounded" alt="">
                        </a>                              
                     </li>
                  </ul>
               </div>
         ...
         <div class="col-lg-12">
            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
               ...
               <div class="iq-card-body">  
                  <div class="row">
                   <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate_pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="javascript:void();"><img class="img-fluid rounded w-100" src="<?php echo e(asset('/uploads/product/' . $cate_pro->product_image)); ?>" alt=""></a>
                                    <div class="view-book">
                                       <a href="<?php echo e(URL::to("/chi-tiet-book/".$cate_pro->product_id)); ?>" class="btn btn-sm btn-white">Mua Ngay</a>
                                    </div>
                                 </div>
                                 <div class="col-6">
                                    <div class="mb-2">
                                       <h6 class="mb-1"> <?php echo e($cate_pro->product_title); ?></h6>
                                       <p class="font-size-13 line-height mb-1"><?php echo e($cate_pro->product_author); ?></p>
                                    ...
                                    <div class="price d-flex align-items-center">
                                       <h6><b><?php echo e($cate_pro->product_price); ?></b></h6>
                                    </div>
                  ...
                  <ul id="favorites-slider" class="list-inline p-0 mb-0 row">
                        ...
                        <div class="d-flex align-items-center">
                           <div class="col-5 p-0 position-relative">
                              <a href="javascript:void();">
                                 <img src="<?php echo e(asset("../FE2/images/favorite/01.jpg")); ?>" class="img-fluid rounded w-100" alt="">
                              </a>                                
                           </div>
                           <div class="col-7">
                     ...
                     <li class="col-md-4">
                        <div class="d-flex align-items-center">
                           <div class="col-5 p-0 position-relative">
                              <a href="javascript:void();">
                                 <img src="<?php echo e(asset("../FE2/images/favorite/02.jpg")); ?>" class="img-fluid rounded w-100" alt="">
                              </a>                                
                           </div>
                           <div class="col-7">
                     ...
                     <li class="col-md-4">
                        <div class="d-flex align-items-center">
                           <div class="col-5 p-0 position-relative">
                              <a href="javascript:void();">
                                 <img src="<?php echo e(asset("../FE2/images/favorite/03.jpg")); ?>" class="img-fluid rounded w-100" alt="">
                              </a>                                
                           </div>
                           <div class="col-7">
                     ...
                     <li class="col-md-4">
                        <div class="d-flex align-items-center">
                           <div class="col-5 p-0 position-relative">
                              <a href="javascript:void();">
                                 <img src="<?php echo e(asset("../FE2/images/favorite/04.jp")); ?>g" class="img-fluid rounded w-100" alt="">
                              </a>                                
                           </div>
                           <div class="col-7">
...
<?php echo $__env->make('layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hct-laravel\hoangcongthanh-final\hoangcongthanh\resources\views/pages/home_2.blade.php ENDPATH**/ ?>