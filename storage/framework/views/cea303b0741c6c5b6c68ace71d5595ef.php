    ...
    <div class="main">
      <form action="/user-login" method="POST" class="form" id="form-2">
        ...
        <div class="form-group">
            ...
            <input id="text" name="user_loginname" 
            type="text" placeholder="VD: email@gmail.com" class="form-control"required="">
...
</html><?php /**PATH C:\xampp\htdocs\hct-laravel\webshopphake\resources\views/user/login.blade.php ENDPATH**/ ?>