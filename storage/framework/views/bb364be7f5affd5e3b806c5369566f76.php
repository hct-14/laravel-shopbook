                     ...
                     <div class="iq-card-transparent iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body p-0">
                            ...
                            <div class="product-count">
                                ...
                                <form action="<?php echo e(url('product/gio-hang')); ?>" method="POST" class="display-flex mb-3">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hct-laravel\webshopphake\resources\views/category/book_page_1.blade.php ENDPATH**/ ?>