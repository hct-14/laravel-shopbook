...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset("../FE/login1.css")); ?>">
</head>
<body>
    <div class="container">
   
            <form action="/user-login-hct" method="POST" class="form" id="login-2">
                <?php echo csrf_field(); ?>
            ...
            <div class="form__input-group">
                ...
                type="text" placeholder="thanh1" class="form-contr  ol"required="">
            ...
            <div class="flex items-center justify-end mt-4" style="width: 100%">
                <a href="<?php echo e(url('authorized/google')); ?>">
        ...
        <form action="<?php echo e(URL::to('user-res')); ?>" class="form form--hidden" id="createAccount" method="POST">
            <?php echo csrf_field(); ?>
...
</body><?php /**PATH C:\xampp\htdocs\hct-laravel\hoangcongthanh-final\resources\views/user/login.blade.php ENDPATH**/ ?>