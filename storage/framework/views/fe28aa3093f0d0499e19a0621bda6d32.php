...
<main>
    ...
    <table class="custom-table">
        ...
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                

        <tr>
            <td><?php echo e($pro_item->order_receiver); ?> </td>
            <td><?php echo e($pro_item->product_title); ?> </td>
            
            <td><?php echo e($pro_item->order_value); ?> </td>

            <td><?php echo e($pro_item->order_phone); ?> </td>
            <td><?php echo e($pro_item->oder_email); ?> </td>
            <td><?php echo e($pro_item->order_address); ?> </td>
            <td><?php echo e($pro_item->order_notes); ?> </td>
            <td>
                <?php if($pro_item->oder_status == 0): ?>
            ...
            <td>
               <a href="<?php echo e(URL::to('/Xoa-order/'.$pro_item->order_id )); ?>">
    ...
    <table class="edit-table" style="display: none;">
        ...
        <tr>
            <form action="<?php echo e(url("/sua-thong-tin")); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <td><input type="hidden" id="order_id" name="order_id" value="<?php echo e($pro_item->order_id); ?>"></td>

                <td><input type="text" id="fullname" name="fullname" value="<?php echo e($pro_item->order_receiver); ?>"></td>
                <td><input type="text" id="phone" name="phone" value="<?php echo e($pro_item->order_phone); ?>"></td>
                <td><input type="text" id="email" name="email" value="<?php echo e($pro_item->oder_email); ?>"></td>
                <td><input type="text" id="address" name="address" value="<?php echo e($pro_item->order_address); ?>"></td>
                <td><input type="text" id="note" name="note" value="<?php echo e($pro_item->order_notes); ?>"></td>
...
<?php /**PATH C:\xampp\htdocs\hct-laravel\hoangcongthanh-final\resources\views/user/kiemtrahang.blade.php ENDPATH**/ ?>